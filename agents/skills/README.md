...
## Agents-specific skills

| Skill | Description |
|-------|-------------|
| [add-todo](add-todo/SKILL.md) | Create and manage `./todos/*.md` work items with helper scripts. |
| [cicero](cicero/SKILL.md) | Use the five classical canons as a disciplined, recursive work protocol before acting. |
| [code-review](code-review/SKILL.md) | Review uncommitted changes or branches, run checks, and save findings to `.reviews/`. |
| [journal](journal/SKILL.md) | Record post-mortems and learnings in `~/.agents/journal/`. |
